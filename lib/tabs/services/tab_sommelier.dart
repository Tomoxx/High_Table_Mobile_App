      ...
      body: ListView(
        children: [
          buildCard(
            ...
            countryName: 'Chile',
            description:
                """Wentru grew up in the tough streets of Puente Alto, Chile, where he became an expert in combat stimulant drugs. He rose through the ranks of local gangs, gaining a reputation for his high-quality products. Now, Wentru lends his expertise to the High Table, supplying specialized combat stimulants for their operatives. Despite his past, he has found a new path, using his knowledge to serve a different kind of clientele.""",
          ),
          buildCard(
              context: context,
